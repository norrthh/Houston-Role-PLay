							...
							<div class = "row" style = "display:unset">
								...
								<div class="col-sm">
									<div class="user__navblock__list">
										...
										<a href="#" onclick="openTabs(event, 'biz')" class = "tablinks"><div class="user__navblock">Бизнес</div></a>
										<a href="#" onclick="openTabs(event, 'house')" class = "tablinks"><div class="user__navblock">Дома</div></a>
								...
								<div class="container">
									<div class="row">
										...
										echo "
											...
											<p>Госс стоимость: <span><?=$biz[bBuyPrice]?></span></p>
											<p>Денег в бизнесе: <span><?=$biz[bMoney]?></span></p>
											<p>Продуктов в бизнесе: <span><?=$biz[bProducts]?></span></p>
											<p>Стомость 1 продукта: <span><?=$biz[bPrice]?></span></p>
											<p>Аренда: <span><?=$biz[bArenda]?></span></p>";
										}
										...
										<div id = "house"  class="biz col-sm tabcontent" style = "height:61vh;display:none;margin-top:9rem;margin-top: 3rem;background: rgba(255,255,255,.04);;border-radius: 15px;padding: 1rem 2rem;margin-left: -1rem;">
											<?
												...
												echo "
													<h1>Номер дома <?= $houm[hID]?></h1>
													
													<p>Владелец дома: <span><?=$houm[hOwner]?></span></p>
													<p>Квартплата: <span><?=$houm[hTakings]?></span></p>
													<p>Оплачео на: <span><?=$houm[hValue]?> дня</span></p>
												";
											}
												else {
